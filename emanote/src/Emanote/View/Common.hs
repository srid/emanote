          ...
          if M.inLiveServer model || not (model ^. M.modelCompileTailwind)
            then do
              ...
              H.link
                ...
                ! A.type_ "text/css"
  "ema:version" ##
    HI.textSplice version
  "ema:generatedByVersion" ##
    HI.textSplice
      ( i18nTextWith
          meta
          "generatedByVersion"
          (Map.fromList [("version", version)])
          ("Generated by Emanote " <> version)
      )
  "ema:metadata" ##
    HJ.bindJson meta
...
i18nTextWith :: Aeson.Value -> Text -> Map Text Text -> Text -> Text
i18nTextWith =
  I18n.lookupTextWith
