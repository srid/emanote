...
- UI revamp (#622, [#636](https://github.com/srid/emanote/pull/636))
  ...
  - The default template now has a note focus button in the note area. It expands the central note column inside the browser window by hiding the sidebar, right-panel, bottom strip, and uptree; the state survives Ema live hot reloads until the user explicitly restores the layout.
