...
- Backlink contexts now retain the order in which repeated links appear in the source Markdown instead of being sorted by context text (closes [#186](https://github.com/srid/emanote/issues/186)).
