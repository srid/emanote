<nav id="sidebar"
  ...
  <div class="px-4 py-5 text-gray-800 dark:text-gray-200">
    <div id="indexing-links" class="flex flex-row float-right space-x-2 text-gray-500 dark:text-gray-400">
    ...
    <div id="site-logo" class="pl-2 mb-4">
      <div class="flex items-center my-3 space-x-2.5 justify-left">
        <ema:metadata>
          <with var="template">
