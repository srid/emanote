<nav id="sidebar"
  ...
  <div class="px-4 py-4 text-gray-800 dark:text-gray-200">
    <div id="indexing-links" class="flex flex-row float-right p-2 space-x-3 text-gray-500 dark:text-gray-400">
