...
<aside data-emanote-note-focus-hide class="emanote-bottom-strip lg:hidden [&:not(:has(*))]:hidden bg-gray-50 dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800 px-4 py-6 space-y-6">
