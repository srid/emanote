...
import Emanote.Model (ModelF, modelLookupNoteByRoute, modelSData)
...
lookupRouteMeta :: FromJSON a => a -> NonEmpty Text -> R.LMLRoute -> ModelF x -> a
...
getEffectiveRouteMeta :: R.LMLRoute -> ModelF x -> Aeson.Value
...
getEffectiveRouteMetaWith :: Aeson.Value -> R.LMLRoute -> ModelF x -> Aeson.Value
...
getYamlMeta :: R.R 'R.Yaml -> ModelF x -> Maybe Aeson.Value
getYamlMeta r model =
